...
parser.add_argument('--exp', type=str,
                    default='Prostate/UACLMI', help='experiment_name')
...
def consist(lafeat1, map1, mask, unfeat1, pred1, unpred_pseudo2):
    ...
    return loss_mat, loss_simi * 0.125
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            dis_to_mask1 = torch.sigmoid(-1500 * tanh1)
            dis_to_mask2 = torch.sigmoid(-1500 * tanh2)
            loss_sdm1 = 0
            loss_sdm2 = 0
            ...
            pseudo_supervision1, loss_simi1 = consist(lafeat2, map, mask, unfeat2, pred1, unpred_pseudo2)
            pseudo_supervision2, loss_simi2 = consist(lafeat1, map, mask, unfeat1, pred2, unpred_pseudo1)
