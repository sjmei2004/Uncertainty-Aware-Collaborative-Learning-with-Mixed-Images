...
from networks.unet import UNet, UNet_DS, UNet_URPC, UNet_CCT, UNet_CCT_CMMT
from networks.unetfeadrop import UNet1,UNet2
import argparse
from networks.vision_transformer import SwinUnet as ViT_seg
from networks.config import get_config
from networks.nnunet import initialize_network
from networks.autoencoder import ResAutoencoder
from networks.unet import UNet_fea,UNet_feaaddSDM,UNet_feaaddSDMCAM
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "UNet_feaaddSDM":
        net = UNet_feaaddSDM(in_chns=in_chns, class_num=class_num).cuda()

    elif net_type == "UNet_feaaddSDMCAM":
        net = UNet_feaaddSDMCAM(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "enet":
    ...
    elif net_type == "aotuencoder":
        net = ResAutoencoder(n_classes=class_num).cuda()
    elif net_type == "UNet_CCT_CMMT":
        net = UNet_CCT_CMMT(in_chns=in_chns, class_num=class_num).cuda()
